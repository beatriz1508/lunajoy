...
export default function EmailsPage() {
  ...
  const handleCopy = async (email: PendingEmail) => {
    const subject = editingId === email.id ? editSubject : email.subject
    const body = editingId === email.id ? editBody : email.body_text
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-900">Follow-Up Emails</h1>
          <p className="text-sm text-slate-500">Review and copy follow-up email drafts generated by Luna.</p>
        </div>
      </div>
